...
An introduction to the command line, Node.js, task runners and advanced Git workflows and how these topics can optimize the process of building modern web applications.

## Course Purpose

This course explores modern development techniques designed to enhance the web development workflow and process.

## Learning Objectives

By the end of the course, student will be able to

- Navigate and manipulate local file system using the command line
- Build basic Node.js scripts/applications
- Use task runners to automate development tasks
- Use the command line for all basic Git configuration and development tasks
- Build Node.js based static site generators
- Build and execute basic shell scripts
...
The "Project" is a team based, term long project. Each member of the team will be assessed throughout the entire term on their contributions and effort. Teams will provide weekly status report updates throughout the term showing progress, accomplishments, schedule, plans, risks and issues.

Review the sample [project status report document](Project-Status-Report.pdf) for examples of how to possibly format the report. Note: This document is not totally applicable for this project and should be used as a guide only.
